...
class AccountManagement extends Component {
    ...
    handleResetPassword = (account, type) => {
        this.setState({
            selectedAccount: { ...account, accountType: type },
            newPassword: '123456',
            showResetModal: true
        });
    };
    ...
    confirmResetPassword = async () => {
        const { selectedAccount, newPassword } = this.state;
        try {
            ...
            this.setState({ showResetModal: false, selectedAccount: null, newPassword: '' });
        } catch (error) {
    ...
    renderAccountTable = (accountList, type) => {
                            ...
                            <tr key={account.id}>
                                ...
                                <td>
                                    <button
                                        ...
                                        onClick={() => this.handleResetPassword(account, type)}
                                    >
                                        🔄 Reset mật khẩu
                                    </button>
                                </td>
    ...
    render() {
        const { accounts, loading, activeTab, showResetModal, selectedAccount, newPassword } = this.state;
            ...
            <div className={styles.container}>
                ...
                <div className={styles.tabs}>
                    ...
                    <button
                        ...
                        onClick={() => this.setState({ activeTab: 'patients' })}
                    >
                ...
                <div className={styles.content}>
                    {activeTab === 'admins' && this.renderAccountTable(accounts.admins, 'admins')}
                    {activeTab === 'doctors' && this.renderAccountTable(accounts.doctors, 'doctors')}
                    {activeTab === 'patients' && this.renderAccountTable(accounts.patients, 'patients')}
                </div>

                {/* Reset Password Modal */}
                {showResetModal && (
                    <div className={styles.modalOverlay} onClick={() => this.setState({ showResetModal: false })}>

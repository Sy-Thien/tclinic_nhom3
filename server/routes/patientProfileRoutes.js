...
router.get('/profile', verifyToken, checkPatientRole, patientProfileController.getPatientProfile);

// ✅ PUT - Cập nhật thông tin khách hàng
router.put('/profile', verifyToken, checkPatientRole, patientProfileController.updatePatientProfile);

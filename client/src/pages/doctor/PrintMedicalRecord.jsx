...
const PrintMedicalRecord = forwardRef(({ patient, history, clinic }, ref) => {
    ...
    // Clinic info (có thể lấy từ config sau)
        ...
        <div ref={ref} className={styles.printContainer}>
            ...
            <div className={styles.patientSection}>
                <div className={styles.patientRow}>
                    ...
                    <div className={styles.patientField}>
                        ...
                        <span className={styles.value}>{calculateAge(patient?.birthday)}</span>
                    </div>
                    <div className={styles.patientField}>
                        <span className={styles.label}>Giới tính:</span>
                        <span className={styles.value}>{getGenderText(patient?.gender)}</span>
                    </div>
                </div>
                <div className={styles.patientRow}>
                    <div className={styles.patientField}>
                ...
                <div className={styles.patientRow}>
                    ...
                    <div className={styles.patientField}>
                        ...
                        <span className={styles.value}>{formatDate(history?.visit_date)}</span>
                    </div>
                </div>
            </div>
                    ...
                    <>
                        ...
                        {prescription.re_exam_date && (
                            <div className={styles.reExamSection}>
                                ...
                                <span className={styles.reExamContent}>{formatDate(prescription.re_exam_date)}</span>
                            </div>
                        )}
                    </>
                ) : (
            ...
            <div className={styles.footer}>
                ...
                <div className={styles.footerRight}>
                    <div className={styles.signatureDate}>
                        TP.HCM, {formatDateFull(history?.visit_date)}
                    </div>
            ...
            <div className={styles.patientCopy}>
                ...
                <div className={styles.copyContent}>
                    <div><strong>BN:</strong> {patient?.full_name} | <strong>Ngày:</strong> {formatDate(history?.visit_date)}</div>
                    ...
                    {prescription?.re_exam_date && (
                        <div className={styles.copyReExam}>
                            <strong>Tái khám:</strong> {formatDate(prescription.re_exam_date)}
                        </div>
                    )}
                </div>
            </div>

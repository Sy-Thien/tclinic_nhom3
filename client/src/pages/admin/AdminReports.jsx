...
export default function AdminReports() {
    ...
    const [revenueStats, setRevenueStats] = useState({ data: [], summary: { totalRevenue: 0, totalCount: 0, avgRevenue: 0 } });
    ...
    const fetchStats = async () => {
        try {
            ...
            setRevenueStats(revenueRes.data || { data: [], summary: { totalRevenue: 0, totalCount: 0, avgRevenue: 0 } });
        } catch (error) {
            console.error('Error fetching report data:', error);
            // Khi API lỗi, giữ dữ liệu rỗng
            setVisitStats([]);
            setTopDoctors([]);
            ...
            setRevenueStats({ data: [], summary: { totalRevenue: 0, totalCount: 0, avgRevenue: 0 } });
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.summaryGrid}>
                <div className={styles.summaryCard} style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' }}>
                ...
                <div className={styles.summaryCard} style={{ background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)' }}>
                    ...
                    <div className={styles.summaryContent}>
                        <div className={styles.summaryValue}>{formatCurrency(summaryStats.totalRevenue)}</div>
                ...
                <div className={styles.summaryCard} style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)' }}>
                    ...
                    <div className={styles.summaryContent}>
                        <div className={styles.summaryValue}>{formatCurrency(summaryStats.avgRevenuePerDay)}</div>
            ...
            <div className={styles.filters}>
                ...
                <div className={styles.exportButtons}>
                    <button onClick={() => handleExport('excel')} className={styles.btnExcel}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="18" height="18">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        Xuất Excel
                    </button>
                    <button onClick={() => handleExport('pdf')} className={styles.btnPdf}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="18" height="18">
                ...
                <>
                    ...
                    <div className={styles.revenueSection}>
                        ...
                        <div className={styles.revenueSummaryRow}>
                            <div className={styles.revenueStat}>
                                ...
                                <span className={styles.revenueStatValue}>{formatCurrency(revenueStats.summary?.totalRevenue || 0)}</span>
                            </div>
                            <div className={styles.revenueStat}>
                            ...
                            <div className={styles.revenueStat}>
                                ...
                                <span className={styles.revenueStatValue}>{formatCurrency(revenueStats.summary?.avgRevenue || 0)}</span>
                            </div>
                        </div>
                    ...
                    <div className={styles.chartsGrid}>
                        <div className={`${styles.chartCard} ${styles.chartWide}`}>
                            <h2>Lượt khám theo {getTypeLabel()}</h2>

const { Patient, Booking, Doctor, Specialty, Service } = require('../Database/Entity');
const { Op } = require('sequelize');
const bcrypt = require('bcryptjs');

// ✅ POST - Tạo bệnh nhân walk-in và booking khám ngay

class DoctorWalkInController {
    ...
    // ✅ GET - Tìm bệnh nhân theo SĐT (để check đã có hồ sơ chưa)
        async searchPatientByPhone(req, res) {
        try {
...
module.exports = new DoctorWalkInController();

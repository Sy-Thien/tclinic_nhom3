const { Patient, Booking, Doctor, Specialty, MedicalHistory, Prescription, PrescriptionDetail, Drug } = require('../Database/Entity');
...
module.exports = new AdminPatientController();

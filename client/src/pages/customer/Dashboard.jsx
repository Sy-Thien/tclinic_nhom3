...
class Dashboard extends Component {
    ...
    fetchAllData = async () => {
        try {
            ...
            this.setState({
                doctors: doctorsRes.data.slice(0, 6),
            ...
            if (token && userStr) {
                try {
                    ...
                    if (user.role === 'patient') {
                        const appointmentsRes = await api.get('/api/patient/bookings/appointments');
    ...
    render() {
        const { navigate } = this.props;
        const { stats, doctors, specialties, services, loading } = this.state;
            ...
            <div className={styles.container}>
                ...
                <section className={styles.cta}>
                    ...
                    <div className={styles.ctaButtons}>
                        <button className={styles.btnPrimary} onClick={this.handleBooking}>
                            📅 Đặt lịch khám
                        </button>

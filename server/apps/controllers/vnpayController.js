...
const { Invoice, InvoiceItem, Booking } = require('../Database/Entity');
        ...
        try {
            ...
            if (secureHash === signed) {
                if (responseCode === '00') {
                    ...
                    // ⏰ GUARD: Chỉ auto-complete nếu đã đến ngày/giờ khám
                        ...
                        if (booking) {
                            ...
                            if (apptDate < todayMidnight) {
                                ...
                                if (booking.appointment_time) {
                                    ...
                                    allowComplete = now.getHours() * 60 + now.getMinutes() >= h * 60 + m - 30;
                                } else {
                                    allowComplete = true;
                                }
                            }
                            ...
                            if (allowComplete) {
                                ...
                                console.log(`✅ Booking ${booking.booking_code} marked as completed after VNPay payment`);
                            } else {
                                console.log(`⚠️ Booking ${booking.booking_code} paid but NOT auto-completed: appointment is in the future`);
                            }
                        }
                    }

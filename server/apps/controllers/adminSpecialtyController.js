const { Specialty, Doctor, Service, Room } = require('../Database/Entity');
...
class AdminSpecialtyController {
        ...
        try {
            ...
            const specialties = await Specialty.findAll({
                ...
                include: [
                    ...
                    },
                    {
                        model: Room,
                        as: 'rooms',
                        attributes: ['id', 'name', 'room_number', 'status'],
                        required: false
                    }
                ],
                order: [['id', 'ASC']]
            ...
            // Thêm số lượng bác sĩ, dịch vụ và phòng khám
            ...
            const specialty = await Specialty.findByPk(id, {
                include: [
                    ...
                    },
                    {
                        model: Room,
                        as: 'rooms',
                        attributes: ['id', 'name', 'room_number', 'floor', 'status', 'capacity']
                    }
                ]
            });
    ...
    // DELETE - Xóa chuyên khoa
        ...
        try {
            ...
            // Gỡ liên kết phòng khám (set specialty_id = null, không xóa phòng)
            await Room.update({ specialty_id: null }, { where: { specialty_id: id } });
...
module.exports = new AdminSpecialtyController();

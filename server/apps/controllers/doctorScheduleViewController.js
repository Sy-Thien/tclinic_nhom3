const { Booking, Patient, Service, Specialty, TimeSlot } = require('../Database/Entity');
const { Op } = require('sequelize');

// GET - Lấy lịch khám của bác sĩ theo ngày

class DoctorScheduleViewController {
    ...
    // GET - Lấy thống kê lịch khám theo tuần/tháng
        async getDoctorScheduleStatistics(req, res) {
        try {
            const doctor_id = req.user.id;
...
module.exports = new DoctorScheduleViewController();
